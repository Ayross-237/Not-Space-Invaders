 ...
 * When updating progress, the increment must be non-negative and the cumulative progress is capped at 1.0.
 */
public interface Achievement {
     ...
     * @requries newProgress is between 0.0 and 1.0, inclusive.
     * @ensures getProgress() == newProgress, getProgress() <= 1.0 after the update (i.e., progress is capped at 1.0).
